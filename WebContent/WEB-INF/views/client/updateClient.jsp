...
<section class="container">
    <form:form modelAttribute="updateClient" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
            <legend>Add new client</legend>
            <div class="form-group">
                <label class="control-label col-lg-2 col-lg-2" for="firstName">First Name</label>
                <div class="col-lg-10">
                    <form:input id="firstName" type="text" path="firstName" class="form:input-large" value="${updateClient.firstName}" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-lg-2 col-lg-2" for="lastName">Last Name</label>
                <div class="col-lg-10">
                    <form:input type="text" id="lastName" path="lastName" class="form:input-large" value="${updateClient.lastName}"/>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-lg-2 col-lg-2" for="email">Email</label>
                <div class="col-lg-10">
                    <form:input type="text" id="email" path="email" class="form:input-large" value="${updateClient.email}"/>
                </div>
            </div>

            <div class="form-group">
                <div class="col-lg-offset-2 col-lg-10">
                    <input type="submit" id="btnAdd" class="btn btn-primary" value="Update Client" />
                </div>
            </div>
        </fieldset>
    </form:form>
